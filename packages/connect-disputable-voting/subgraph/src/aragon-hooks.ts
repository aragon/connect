...
export function getTemplateForApp(appId: string): string | null {
  if (appId == '0x34c62f3aec3073826f39c2c35e9a1297d9dbf3cc77472283106f09eee9cf47bf') {
    return 'Agreement'
  } else if (appId == '0x705b5084c67966bb8e4640b28bab7a1e51e03d209d84e3a04d2a4f7415f93b34') {
