...
![The decentralized nature of organizations allows to access them in various ways.](./assets/basics-organization.png)
...
![There are multiple templates to choose from, or you can create your own.](./assets/basics-templates.png)
...
![Aragon apps are represented by a smart contract, and might also provide a frontend.](./assets/basics-apps-two-parts.png)
